...
import { Form, Input, InputNumber, Button, Rate, Switch, Row, Col } from "antd";
      ...
      <GenericSection>
        <div className="container">
          ...
          >
            ...
            <Form.Item name="liveAgain">
              <Switch />
              <label style={{ color: "white" }}>Will live again?</label>
            </Form.Item>

            <Form.Item name="postAnonymously">
              <Switch></Switch>
